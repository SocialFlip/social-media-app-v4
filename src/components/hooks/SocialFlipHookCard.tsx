...
import { Brain, Lightbulb, BookOpen, BarChart2, Blocks, GraduationCap, AlertTriangle, ListChecks, AlertOctagon, Crown, HelpCircle, Maximize2, Edit2, Copy, Check, Trash2 } from 'lucide-react';
import { HookModal } from './HookModal';
import { useAuthStore } from '@/stores/authStore';

interface SocialFlipHookCardProps {
  hook: Hook;
  onDelete?: (hook: Hook) => void;
  onUpdate?: (hook: Hook) => void;
}

export const SocialFlipHookCard: React.FC<SocialFlipHookCardProps> = ({ hook, onDelete, onUpdate }) => {
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group hover:shadow-md transition-shadow">
        <div className="p-6">
          ...
          <div className="prose max-w-none text-gray-600">
            <pre className="whitespace-pre-wrap text-sm font-normal bg-gray-50 p-4 rounded-lg line-clamp-3">
              {hook.content}
            </pre>
          </div>
